...
class _GroupAccountsState extends State<GroupAccounts> {
  ...
  Widget build(BuildContext context) {
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: <Widget>[
                      SizedBox(height: 5.0,),
                      Text("Join a group by entering the account number",
                                ...
                                child: FlatButton(
                                  onPressed: (){
                                   if(_formkey.currentState.validate()){
                                     searchAccount(acccountEditingController.text);
                                   }
                                  },
                                    color: mainColor ,
                                    ...
                                    child: Row(
                                      children: <Widget>[
                                        Icon(FontAwesomeIcons.search,color: white,size: 14.0,),
                                        SizedBox(
                                          width: 4.0,
                                        ),
                                        Text("search",
                  ...
                  builder: (context,snapshot){
                    if(snapshot.hasData){
                      if(snapshot.data.length == 0 || snapshot.data == null){
                        return Center(child: Text("No Group Account Found."),);
                      }
                        ...
                        shrinkWrap: true,
                          ...
                          itemBuilder: (context,index){
                            ...
                            return Column(
                              children: <Widget>[
                                ListTile(
                                  leading: getLeadingText(snapshot.data[index].accountName),
                                  title: Text(snapshot.data[index].accountName),
                                  subtitle: Text(snapshot.data[index].accountNumber),
    ...
    void searchAccount(String text) {}
