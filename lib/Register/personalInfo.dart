...
class _PersonalInfoState extends State<PersonalInfo> {
  ...
  register(
    ...
    try{
      ...
      var response = await client.post("http://192.168.43.143:8080/api/auth/signup",body: data,headers: headers);
                        ...
                        TextFormField(
                          ...
                          validator: (password){
                            ...
                            if(password.length<8){
                              return "The password field must contain more than 8 characters";
                            }
                            return null;
                          },
                          keyboardType: TextInputType.text,
